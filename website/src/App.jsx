      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        {isMenuOpen && (
          <div className="md:hidden fixed inset-0 top-20 bg-black/95 backdrop-blur-2xl z-40">
            ...
            <div
              className="absolute top-32 right-16 w-1 h-1 bg-yellow-500/70 rounded-full floating-element"
              style={{ animationDelay: "1s" }}
            ></div>
            <div
              className="absolute bottom-32 left-1/4 w-1.5 h-1.5 bg-yellow-300/60 rounded-full floating-element"
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <div
              key={index}
              className="group relative p-8 bg-gradient-to-b from-gray-800/50 to-gray-900/50 rounded-2xl border border-yellow-600/20 hover:border-yellow-400/40 transition-all duration-300 hover:transform hover:scale-105"
            >
              ...
              <h3 className="gravesend-sans text-2xl font-semibold text-white mb-4">
                {feature.title}
              </h3>
              <p className="century-gothic text-gray-300 leading-relaxed">
                {feature.description}
              </p>
            </div>
          ))}
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={index}
                className="group relative p-6 bg-gradient-to-b from-gray-800/30 to-gray-900/30 rounded-xl border border-yellow-600/20 hover:border-yellow-400/40 transition-all duration-300 hover:transform hover:scale-105"
              >
                <div className="text-4xl mb-4">{offering.image}</div>
                <h3 className="gravesend-sans text-xl font-semibold text-white mb-3">
                  {offering.title}
                </h3>
            ...
            {[
              ...
              <div key={index} className="relative text-center">
                <div className="w-20 h-20 bg-gradient-to-br from-yellow-400 to-yellow-600 rounded-full flex items-center justify-center mx-auto mb-6 shadow-2xl shadow-yellow-500/30">
                  <span className="gravesend-sans text-2xl font-bold text-black">
                    {step.step}
                  </span>
                </div>
                <h3 className="gravesend-sans text-2xl font-semibold text-white mb-4">
  ...
  const events = [
    {
      ...
      category: "Football",
      description:
        "Experience the greatest rivalry in English football with premium hospitality at Old Trafford.",
      features: [
        "VIP Seating",
        "Gourmet Dining",
        "Meet & Greet",
    ...
    },
    {
      ...
      category: "Formula 1",
      description:
        "The jewel in the F1 calendar with unparalleled luxury and glamour.",
      features: [
        "Paddock Access",
        "Yacht Hospitality",
        "Champagne Reception",
    ...
    },
    {
      ...
      category: "Rugby",
      description:
        "Witness rugby history at the most prestigious tournament final.",
      features: [
        "Premium Seats",
        "Fine Dining",
        "Former Player Meet",
    ...
    },
    {
      ...
      category: "Golf",
      description:
        "Golf's most coveted tournament with exclusive clubhouse access.",
      features: [
        "Course Access",
        "Augusta Dining",
        "Pro-Am Viewing",
    ...
    },
    {
      ...
      category: "Football",
      description:
        "English football's oldest competition at the home of football.",
      features: [
        "Wembley Suite",
        "Three-Course Meal",
        "Bar Package",
    ...
    },
    {
      ...
      category: "Tennis",
      description:
        "The most prestigious tennis tournament with traditional hospitality.",
      features: [
        "Centre Court",
        "Strawberries & Cream",
        "Pimm's Reception",
    ...
    <div className="pt-20 min-h-screen bg-gradient-to-br from-black via-gray-900 to-black">
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="text-center mb-16">
          ...
          <p className="century-gothic text-xl text-gray-300 max-w-3xl mx-auto">
            Discover our exclusive collection of premium sporting events with
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredEvents.map((event) => (
            <div
              key={event.id}
              className="group relative bg-gradient-to-b from-gray-800/50 to-gray-900/50 rounded-2xl border border-yellow-600/20 hover:border-yellow-400/40 transition-all duration-300 hover:transform hover:scale-105 overflow-hidden"
            >
              <div className="p-6">
                ...
                <div className="space-y-2 mb-4">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="century-gothic text-gray-300 text-sm">
                      {event.date}
                    </span>
                  </div>
                  <div className="flex items-center space-x-2">
                ...
                <div className="space-y-2 mb-6">
                  {event.features.slice(0, 2).map((feature, index) => (
                    <div key={index} className="flex items-center space-x-2">
                      ...
                      <span className="century-gothic text-gray-300 text-xs">
                        {feature}
                      </span>
                    </div>
                  ))}
          ...
          <div className="fixed inset-0 bg-black/80 backdrop-blur-lg z-50 flex items-center justify-center p-6">
            <div className="bg-gradient-to-b from-gray-800 to-gray-900 rounded-2xl border border-yellow-600/30 max-w-2xl w-full max-h-[90vh] overflow-y-auto">
              <div className="p-8">
                ...
                <div className="mb-8">
                  <h3 className="gravesend-sans text-xl font-semibold text-white mb-4">
                    Package Includes:
                  </h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    {selectedEvent.features.map((feature, index) => (
                      <div key={index} className="flex items-center space-x-3">
                        ...
                        <span className="century-gothic text-gray-300">
                          {feature}
                        </span>
                      </div>
                    ))}
...
const ContactForm = ({ eventTitle = "" }) => {
  ...
  return (
    <div className="bg-gradient-to-br from-gray-800/30 to-gray-900/30 rounded-xl p-6 border border-yellow-600/20">
      <h3 className="gravesend-sans text-2xl font-bold text-white mb-6">
      ...
      {isSubmitted ? (
        <div className="text-center py-8">
          ...
          <h4 className="gravesend-sans text-xl font-semibold text-white mb-2">
            Request Submitted!
          </h4>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="mb-4">
            <p className="century-gothic text-white mb-2">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            <div className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 rounded-2xl p-8 border border-yellow-600/20">
              <h2 className="gravesend-sans text-3xl font-bold text-white mb-8">
                Get In Touch
              </h2>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="gravesend-sans text-xl font-semibold text-white mb-2">
                      Phone
                    </h3>
                    <p className="century-gothic text-gray-300">
                      +263 70 000 0000
            ...
            <div className="bg-gradient-to-br from-yellow-400/10 to-yellow-600/10 rounded-2xl p-8 border border-yellow-600/30">
              <h3 className="gravesend-sans text-2xl font-bold text-white mb-4">
                Prefer a Call Back?
              </h3>
        ...
        <div className="mt-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              ...
              <div
                key={index}
                className="bg-gradient-to-br from-gray-800/30 to-gray-900/30 rounded-xl p-6 border border-yellow-600/20"
              >
                <h3 className="gravesend-sans text-lg font-semibold text-white mb-3">
                  {faq.question}
                </h3>
                <p className="century-gothic text-gray-300 text-sm leading-relaxed">
                  {faq.answer}
