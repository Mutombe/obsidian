  ...
  const events = [
    {
      ...
      price: "From £650",
      category: "Soccer",
      description: "Experience the greatest rivalries in English Soccer with premium hospitality packages.",
    ...
    },
    {
      ...
      price: "From £2,500",
      category: "Formula 1",
      description: "The pinnacle of motorsport with unparalleled luxury and glamour at exclusive circuits.",
    ...
    },
    {
      ...
      price: "From £1,200",
      category: "Rugby",
      description: "Witness rugby's greatest moments at the most prestigious tournaments worldwide.",
    ...
    },
    {
      ...
      price: "From £3,000",
      category: "Golf",
      description: "Golf's most coveted tournaments with exclusive clubhouse access and premium experiences.",
      features: ["Course Access", "Clubhouse Dining", "Pro-Am Viewing", "Gift Shop Access"],
    ...
    },
    {
      ...
      price: "From £950",
      category: "Tennis",
      description: "The most prestigious tennis tournaments with traditional hospitality and exclusive access.",
      features: ["Centre Court", "Strawberries & Cream", "Reception Access", "Player Practice"],
...
const BookingModal = ({ event, onClose }) => {
  ...
  const handleBooking = () => {
    if (eventDetails.trim() && name.trim() && email.trim()) {
      // Here you would typically handle the booking
      alert(`Booking request submitted for ${event.category}!\nEvent: ${eventDetails}\nName: ${name}\nEmail: ${email}`);
      onClose();
    } else {
      ...
      >
        ...
        <div className="relative h-48 sm:h-64 overflow-hidden">
          ...
          <div className="absolute bottom-4 sm:bottom-6 left-4 sm:left-6 text-white">
            ...
            <h2 className="gravesend-sans text-xl sm:text-2xl lg:text-3xl font-bold mt-2 sm:mt-3 mb-1">Book {event.title} Experience</h2>
          </div>
        </div>
        ...
        <div className="p-4 sm:p-6 lg:p-8">
          <div className="mb-6 sm:mb-8">
            <h3 className="gravesend-sans text-lg sm:text-xl font-semibold text-black mb-3 sm:mb-4">Tell us about your desired event</h3>
          ...
          <div className="space-y-4 sm:space-y-6">
            <div>
              <label className="gravesend-sans block text-sm font-semibold text-gray-700 mb-2">
                Your Name *
              </label>
              <input
                type="text"
            ...
            <div>
              <label className="gravesend-sans block text-sm font-semibold text-gray-700 mb-2">
                Which {event.category} event would you like to attend? *
              </label>
              <textarea
                value={eventDetails}
                ...
                placeholder={`Describe the specific ${event.category} event you want to attend (e.g., "Manchester United vs Liverpool at Old Trafford" or "Monaco Grand Prix")
...
Or you can type "I'm not sure" & we will contact you with fixtures.`}
            ...
            {/* Package Features */}
            <div>
              <h4 className="gravesend-sans text-sm font-semibold text-gray-700 mb-3">Package Includes:</h4>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                {event.features.map((feature, index) => (
                  ...
                  >
                    <Check size={14} className="text-yellow-600 flex-shrink-0" />
                    <span className="gravesend-sans text-gray-700">{feature}</span>
                  </div>
                ))}
              </div>
            </div>
          ...
          <div className="border-t border-gray-200 pt-6 mt-8">
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
              ...
              <motion.button
                ...
                className="century-gothic px-6 sm:px-8 py-3 bg-gradient-to-r from-yellow-500 to-yellow-600 text-white font-semibold flex items-center justify-center gap-2 text-sm sm:text-base flex-1"
              >
